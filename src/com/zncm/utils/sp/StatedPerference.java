...
public class StatedPerference extends SharedPerferenceBase {
    ...
    public static void setDifficulty(Integer difficulty) {
        putInt(getSharedPreferences(), Key.difficulty.toString(), difficulty);
    }

    public static Integer getDifficulty() {
        return getInt(getSharedPreferences(), Key.difficulty.toString(), 10);
    }

    public static void setQNumber(Integer qnumber) {
        putInt(getSharedPreferences(), Key.qnumber.toString(), qnumber);
    }

    public static Integer getQNumber() {
        return getInt(getSharedPreferences(), Key.qnumber.toString(), 10);
    }
