...
public class DatabaseHelper extends OrmLiteSqliteOpenHelper {
    ...
    private RuntimeExceptionDao<TestData, Integer> testRuntimeDao = null;
    ...
    public void onCreate(SQLiteDatabase db, ConnectionSource connectionSource) {
        try {
            ...
            TableUtils.createTableIfNotExists(connectionSource, TestData.class);
    ...
    public RuntimeExceptionDao<TestData, Integer> getTestDataDao() {
        if (testRuntimeDao == null) {
            testRuntimeDao = getRuntimeExceptionDao(TestData.class);
        }
