...
import com.zncm.component.pullrefresh.internal.EmptyViewMethodAccessor;
import com.zncm.component.pullrefresh.internal.IndicatorLayout;
...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView>
    ...
    public final void needEmptyView(String text) {
        LayoutInflater mInflater = (LayoutInflater) SharedApplication.getInstance().ctx
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        RelativeLayout newEmptyView = (RelativeLayout) mInflater.inflate(R.layout.view_data_null, null);
        TextView tvNull = (TextView) newEmptyView.findViewById(R.id.tvNull);
        if (StrUtil.notEmptyOrNull(text)) {
            tvNull.setText(text);
        }
        FrameLayout refreshableViewWrapper = getRefreshableViewWrapper();
        if (null != newEmptyView) {
    ...
    private boolean isLastItemVisible() {
        ...
        if (null == adapter || adapter.isEmpty()) {
            ...
            if (L.D) {
                L.d("isLastItemVisible. Last Item Position: "
