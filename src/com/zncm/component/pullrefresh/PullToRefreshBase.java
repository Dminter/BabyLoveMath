...
import com.zncm.component.pullrefresh.internal.FlipLoadingLayout;
import com.zncm.component.pullrefresh.internal.LoadingLayout;
import com.zncm.component.pullrefresh.internal.RotateLoadingLayout;
import com.zncm.component.pullrefresh.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout
    ...
    private OnRefreshListenerBoth<T> mOnRefreshListenerBoth;
    ...
    public void addView(View child, int index, ViewGroup.LayoutParams params) {
        if (L.D) {
            L.d("addView: " + child.getClass().getSimpleName());
        }
            ...
            case MotionEvent.ACTION_UP: {
                if (mIsBeingDragged) {
                    ...
                    if (mState == State.RELEASE_TO_REFRESH
                            && (null != mOnRefreshListener || null != mOnRefreshListenerBoth)) {
    ...
    public final void setOnRefreshListener(OnRefreshListener<T> listener) {
        ...
        mOnRefreshListenerBoth = null;
    }

    @Override
    public final void setOnRefreshListener(OnRefreshListenerBoth<T> listener) {
        mOnRefreshListenerBoth = listener;
    ...
    /**
     * @return Either {@link com.zncm.component.pullrefresh.PullToRefreshBase.Orientation#VERTICAL} or
     * {@link com.zncm.component.pullrefresh.PullToRefreshBase.Orientation#HORIZONTAL} depending on the scroll direction.
     */
     ...
     * {@link com.zncm.component.pullrefresh.PullToRefreshBase.State#PULL_TO_REFRESH} state.
     */
    ...
    /**
     * Called when the UI has been to be updated to be in the
     * {@link com.zncm.component.pullrefresh.PullToRefreshBase.State#REFRESHING} or {@link com.zncm.component.pullrefresh.PullToRefreshBase.State#MANUAL_REFRESHING} state.
     *
    ...
    /**
     * Called when the UI has been to be updated to be in the
     * {@link com.zncm.component.pullrefresh.PullToRefreshBase.State#RELEASE_TO_REFRESH} state.
     */
    ...
    /**
     * Called when the UI has been to be updated to be in the
     * {@link com.zncm.component.pullrefresh.PullToRefreshBase.State#RESET} state.
     */
    ...
    protected final void refreshLoadingViewsSize() {
        ...
        // if (DEBUG) {
        // Log.d(LOG_TAG,
        // String.format("Setting Padding. L: %d, T: %d, R: %d, B: %d", pLeft,
        // pTop, pRight, pBottom));
        // }
    ...
    private void callRefreshListener() {
        ...
        } else if (null != mOnRefreshListenerBoth) {
            if (mCurrentMode == Mode.PULL_FROM_START) {
                mOnRefreshListenerBoth.onPullDownToRefresh(this);
            } else if (mCurrentMode == Mode.PULL_FROM_END) {
                mOnRefreshListenerBoth.onPullUpToRefresh(this);
            }
        }
    }
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (a.hasValue(R.styleable.PullToRefresh_ptrRefreshableViewBackground)) {
            ...
            if (L.D) {
                L.w("ptrAdapterViewBackground" + "ptrRefreshableViewBackground");
            }
            Drawable background = a
    ...
    public static enum Mode {
         ...
         * {@link com.zncm.component.pullrefresh.PullToRefreshBase#setRefreshing() setRefreshing()}.
         */
    ...
    public static interface OnPullEventListener<V extends View> {
         ...
         * @param direction   - One of {@link com.zncm.component.pullrefresh.PullToRefreshBase.Mode#PULL_FROM_START} or
         *                    {@link com.zncm.component.pullrefresh.PullToRefreshBase.Mode#PULL_FROM_END} depending on which direction
         *                    the user is pulling. Only useful when <var>state</var> is
         *                    {@link com.zncm.component.pullrefresh.PullToRefreshBase.State#PULL_TO_REFRESH} or
         *                    {@link com.zncm.component.pullrefresh.PullToRefreshBase.State#RELEASE_TO_REFRESH}.
         */
